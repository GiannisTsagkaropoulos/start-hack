  ...
  return (
    <section className="max-w-5xl mx-auto px-4 py-20">
      ...
      <p className="text-center text-xs text-slate-400 mt-8">
        Purchase IDs are from the official Viseca sponsor dataset — not scripted
        for the demo.
      </p>

      <section className="relative max-w-4xl mx-auto py-20">
        <div className="max-lg:hidden absolute top-1/4 -left-4 -translate-x-full text-sm flex flex-col gap-1 items-center">
          <p className="text-base-content-secondary">Leash in 3 minutes</p>
          <svg
            className="w-12 h-12 fill-base-content-secondary"
            viewBox="0 0 130 130"
        ...
        <div className="relative w-full aspect-video overflow-hidden sm:rounded">
          <iframe
            src="https://drive.google.com/file/d/19LzSmUfv2JwsYsydoJAQfLtXJHWHVudw/preview"
            width="100%"
            height="100%"
            allow="autoplay"
            allowFullScreen
            className="absolute inset-0 w-full h-full border-0"
            title="StartHack 2026 Demo Video"
          ></iframe>
        </div>
      </section>
    </section>
